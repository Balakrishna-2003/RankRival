...
public class LeaderBoard_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout main_linear = findViewById(R.id.addLinear);
        RelativeLayout main = findViewById(R.id.main);
        CIE_2 = findViewById(R.id.CIE_2);
        CIE_2.setOnClickListener(view -> {
            startActivity(new Intent(LeaderBoard_page.this, LeaderBoard1_cie.class));
        });
        ...
        db.collection("users")
                .orderBy("cie1_total", Query.Direction.DESCENDING)
                .get()
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                CardView cardView = new CardView(LeaderBoard_page.this);
                                ...
                                LinearLayout linearLayout1 = new LinearLayout(LeaderBoard_page.this);
                                ...
                                TextView ts = new TextView(LeaderBoard_page.this);
                                ...
                                LinearLayout inner_linear = new LinearLayout(LeaderBoard_page.this);
                                ...
                                TextView btn1 = new TextView(LeaderBoard_page.this);
                                btn1.setText("Total marks: "+document.get("cie1_total"));
                                ...
                                tsl2.setMargins(50, 0, 50, 20);
                                btn1.setLayoutParams(tsl2);
                                btn1.setGravity(Gravity.CENTER);
                                btn1.setBackground(getDrawable(R.drawable.cutom_button));

//            btn1.setPadding(50,30,20,30);
                                btn1.setTextSize(25);

                                //int marks = (int) document.get("cie1_total");  // Example input

                                ImageView img = new ImageView(LeaderBoard_page.this);


                                if(count >= 0 && count <= 2){

                                    if(count == 0){
                                        img.setImageDrawable(getDrawable(R.drawable.i));
                                    }else if(count == 1){
                                        img.setImageDrawable(getDrawable(R.drawable.g));
                                    }else{
                                        img.setImageDrawable(getDrawable(R.drawable.h));
                                    }

                                    LinearLayout.LayoutParams tsl1 = new LinearLayout.LayoutParams(450, 450);
